...
namespace TesteCrud.Controllers
{
    public class ImoveisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TipoNegocio,ValorImovel,Descricao,ImovelAtivo")] Imovel imovel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TipoNegocio,ValorImovel,Descricao,ImovelAtivo")] Imovel imovel)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Imovel imovel = db.Imoveis.Find(id);
            if (db.Clientes.Any(x => x.IdImovel == id))
            {                
